...
export default function Sidebar() {
  return (
    <aside className="w-60 flex-shrink-0 bg-navy flex flex-col h-full">
      ...
      {/* Settings */}
      <div className="px-3 py-4 border-t border-navy-light space-y-2">
        ...
        <button
          type="button"
          onClick={onLogout}
          className="w-full text-left flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-blue-100 hover:bg-navy-light hover:text-white transition-colors duration-150"
        >
          <Zap size={18} />
          Cerrar sesión
        </button>
